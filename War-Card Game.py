...
for rank in range(26):
    player1.add_cards(mydeck.deal_one())
    player2.add_cards(mydeck.deal_one())
...
while game_on:
    ...
    if len(player1.all_cards)== 0:
        print(f"{player1.name}, out of cards! Player Two Wins!")
        game_on=False
        break
    if len(player2.all_cards)== 0:
        print(f"{player2.name}, out of cards! Player One Wins!")
        game_on=False
        break
